              ...
              >
                ...
                {openConnection === "ai" ? (
                  <div className="connection-details" id="ai-connection-details">
                    ...
                    <p className="muted">
                      Local subscriptions aren’t configured here. On each execution computer, run{" "}
                      <code>codex login</code> or <code>claude auth login</code>, then check
                      readiness in Local Agent → Diagnostics.
                    </p>
                  </div>
                ) : null}
              </article>
