...
function promptInput(
  ...
  return {
    ...
    run: {
      ...
      stop_reason: null,
      actor_execution_snapshots: [
        {
          actor_id: selectedActor.id,
          provider: selectedActor.provider,
          model: selectedActor.model,
          runtime: selectedActor.runtime,
          max_input_tokens: selectedActor.max_input_tokens,
          max_output_tokens: selectedActor.max_output_tokens,
          budget_limit_usd: selectedActor.budget_limit_usd,
          max_turns: selectedActor.max_turns,
          pricing: {
            provider: selectedActor.provider,
            model: selectedActor.model,
